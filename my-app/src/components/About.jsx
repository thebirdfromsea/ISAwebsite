    ...
    <MDBRow className="py-5">
      <MDBCol md="12" className="text-center">
        <p>
            ...
            Baton Rouge community. We are devoted to interpersonal connections and cross-cultural excellence 
            among our members by championing initiatives, and organizing social, cultural, and career 
            development events. We work to create a more inclusive and prosperous international community at
        </p>
      </MDBCol>
    </MDBRow>
  </MDBContainer>
